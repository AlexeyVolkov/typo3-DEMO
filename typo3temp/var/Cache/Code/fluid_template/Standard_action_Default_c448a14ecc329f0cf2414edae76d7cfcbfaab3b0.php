...
class Standard_action_Default_c448a14ecc329f0cf2414edae76d7cfcbfaab3b0 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output0 .= '
    ...
    <div style="background-color: yellow; padding: 0.5em 1em;">
        <dl>
            <dt>Template file</dt>
            <dd>
                <code>typo3conf/ext/youtube_demo/Resources/Private/Templates/Page/Default.html</code>
            </dd>
            <dt>Backend Configuration</dt>
            <dd>
                <code>typo3conf/ext/youtube_demo/Configuration/PageTS/Mod/WebLayout/BackendLayouts/default.txt</code>
            </dd>
        </dl>
    </div>
